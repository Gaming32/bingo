...
public class BingoTagProvider implements DataProvider {
    ...
    private void addTags(Consumer<BingoTag> tagAdder) {
        ...
        tagAdder.accept(BingoTag.builder(BingoTags.FINISH).difficultyMax(1, 1, 1, 1, 1).build());
        ...
        tagAdder.accept(BingoTag.builder(BingoTags.NEVER).difficultyMax(3, 3, 3, 2, 1).disallowOnSameLine().isNever().build());
